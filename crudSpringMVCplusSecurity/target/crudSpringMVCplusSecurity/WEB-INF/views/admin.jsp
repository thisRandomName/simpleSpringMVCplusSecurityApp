...
<body id="bd">
        ...
        <div class="collapse navbar-collapse" id="navbar-list-2">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value="/admin/list" />">View users</a>
                </li>
                <li class="nav-item">
    ...
    <p>Dear <strong>${user}</strong>, Welcome to Admin Page! Choose whether to view the users' list or log out
    </p>
</body>
</html>