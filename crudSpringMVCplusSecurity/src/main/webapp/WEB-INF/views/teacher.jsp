...
<body id="bd">
        ...
        <div class="collapse navbar-collapse" id="navbar-list-2">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<c:url value="/teacher/courselist" />">View courses</a>
                </li>
                <li class="nav-item">
    ...
    <p>Dear <strong>${user}</strong>, Welcome to Teacher Page! Choose whether to view the courses' list or log out
    </p>
</body>
</html>